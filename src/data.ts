...
export const defaultConfig: ServerConfig = {
  ...
  pve: true, hardcore: false, disableFriendlyFire: false, disableFriendlyFirePvP: false, enablePvPGamma: true, allowHitMarkers: true,
  allowHideDamageSourceFromLogs: true, globalVoiceChat: false, proximityChat: false, preventSpawnAnimations: false,
  serverForceNoHud: false, showFloatingDamageText: false, showPlayerJoinNotifications: true,
  ...
  dinoHealthRecoveryMultiplier: 1, oxygenSwimSpeedStatMultiplier: 1, playerHealthRecoveryMultiplier: 1,
  ...
  fuelConsumptionIntervalMultiplier: 1, clampItemSpoilingTimes: false, clampResourceHarvestDamage: false, randomSupplyCratePoints: false,
  itemStackSizeMultiplier: 1, itemStackOverrides: [], globalSpoilingTimeMultiplier: 1,
  ...
  disableImprintDinoBuff: false, preventMateBoost: false, poopIntervalMultiplier: 1, wildDinoFoodDrainMultiplier: 1,
  structureLimit: 10500, platformStructureMultiplier: 1.5, platformSaddleBuildAreaBoundsMultiplier: 1,
  structureResistanceMultiplier: 1, disablePlacementCollision: true,
  pveAllowStructuresAtSupplyDrops: false, enableExtraStructurePreventionVolumes: false,
  maxTribeSize: 8, tribeAlliances: true, pveStructureDecay: false,
  allowCaveBuildingPvE: false, allowCaveBuildingPvP: true, structureDamageRepairCooldown: 180,
  alwaysAllowStructurePickup: false, structurePickupTimeAfterPlacement: 30, structurePickupHoldDuration: 0.5,
  ...
  allowMultipleAttachedC4: false, forceAllStructureLocking: false, disableWirelessCrafting: false, wirelessCraftingRangeOverride: 3000,
  ...
  allowRaidDinoFeeding: false, maxPersonalTamedDinos: 0, maxTamedDinosSoftTameLimit: 5000,
  maxTamedDinosSoftTameLimitCountdown: 604800, destroyTamesOverSoftTameLimit: false, useDinoLevelUpAnimations: true,
  ...
  maxTributeDinos: 20, maxTributeItems: 50,
  ...
  preventOfflinePvP: false, preventOfflinePvPInterval: 0, pveDinoDecay: true, pveDinoDecayPeriodMultiplier: 1, pvpDinoDecay: false,
  allowUnlimitedRespecs: false, craftingSkillBonusMultiplier: 1, craftXpMultiplier: 1,
  customRecipeEffectivenessMultiplier: 1, customRecipeSkillMultiplier: 1,
  genericXpMultiplier: 1, harvestXpMultiplier: 1, killXpMultiplier: 1, specialXpMultiplier: 1,
  hairGrowthSpeedMultiplier: 0, maxFallSpeedMultiplier: 1, disablePhotoMode: false, photoModeRangeLimit: 3000, showCreativeMode: false,
  ...
  noDinos: false, noWildBabies: false, disableCustomCosmetics: false, unstasisDinoObstructionCheck: false,
  useServerNetSpeedCheck: false, noSound: false, customLaunchArgs: '-culture=zh',
  customServerSettings: '', customGameIniSettings: '', customEngineIniSettings: '',
  serverGameLog: true, serverGameLogIncludeTribe: true, adminLogging: true, chatLogging: true,
